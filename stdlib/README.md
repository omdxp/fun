...
- **std/channel.fn**: Bounded blocking ring-buffer channels with timeout send/recv, configurable select wait-slice tuning, plus select_recv_with and select_recv3_rr_with helpers on top of std.sync.
